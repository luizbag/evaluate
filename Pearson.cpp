...
Pearson::Pearson() : Similarity("Pearson correlation", "P", true)  {
	// true - Pearson is a correlation measure (similarity)
}
...
double Pearson::calculate(const Object &objAObject_1, const Object &objAObject_2) {
	...
	// Certificates if both vector of features have the same size
